  ...
  supabase: {
    ...
    icon: (
      ...
      >
        ...
        <path
          d="M23.5 30.5v-24c0-1.9-2.3-2.7-3.4-1.2l-16 21c-1.3 1.7-.1 4.2 2 4.2zm0-12v24c0 1.9 2.4 2.7 3.6 1.2l16.8-21c1.4-1.7.1-4.2-2.1-4.2z"
          fill="none"
          stroke="currentColor"
          strokeMiterlimit="10"
          strokeWidth="3"
...
export function TechStackFull({
  ...
  return (
    <div className={cn("w-full py-6", className)}>
      <div className="flex flex-wrap justify-between items-stretch gap-3 w-full">
        {technologies.map((tech) => (
          <Tooltip key={tech}>
            <TooltipTrigger className="flex flex-col items-center gap-2 p-4 rounded-xl bg-card/50 hover:bg-card/80 transition-colors border shadow-sm min-w-[120px] flex-grow flex-shrink basis-0 max-w-[200px] h-full">
              <div className="rounded-full bg-background p-3 border">
                {techComponents[tech].icon}
              </div>
              <span className="text-sm font-medium text-center">
                {techComponents[tech].name}
              </span>
            </TooltipTrigger>
            <TooltipContent>
              <p>{techComponents[tech].name}</p>
