...
<TabsContent value="cli">
  ```bash npx shadcn@latest add "https://ui.shaduxe.com/r/button" ```
</TabsContent>
...
<ComponentPreview name="button-icon-example" />

### Small Button

<ComponentPreview name="button-sm-example" />

### Large Button

<ComponentPreview name="button-lg-example" />
